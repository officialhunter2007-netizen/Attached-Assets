...
- المعلّم الذكي يملك أدوات بصرية: `python_trace` (تتبّع تنفيذ الكود سطراً سطراً مع المتغيّرات)، `flowchart` (الخوارزميات والقرارات). صمّم المحتوى ليستدعي هذه الأدوات طبيعياً.
