...
SPEC_DESC="${SPEC_DESC:-مهارة عملية شاملة لإتقان البرمجة بلغة بايثون من الصفر حتى بناء مشاريع حقيقية، بالتطبيق المباشر داخل محرّر نُخبة وبأمثلة من حياة الطالب اليمني.}"
...
أنت خبير تدريس برمجة بلغة بايثون ومُصمِّم مناهج عربي، تبني مساراً عملياً تكيّفياً للطلاب اليمنيين، وتُنتج ملف تعليمات v4.1 لمنصّة نُخبة (Nukhba) لمهارة «البرمجة بلغة بايثون» داخل قسم المهارات.
...
4. **أمثلة من الحياة اليمنية بكود بايثون**: حساب الباقي في السوق، تحويل العملة (ريال/دولار/سعودي) عند الصرّاف، جدول انقطاع الكهرباء، حساب أجرة الباص، فاتورة الدكان، أوزان البنّ والخضار، معدّل الطالب في الجامعة، مخزون الصيدلية. اجعل الكود يحلّ مشكلة يلمسها الطالب.
...
التدرّج العلمي المطلوب لمنهج بايثون (التزِم بروحه):
- مستوى 1 (تأسيس): ما هي البرمجة، تشغيل أول كود، المتغيّرات، الأنواع (int/float/str/bool)، الإدخال/الإخراج، العمليات الحسابية والنصّية.
- مستوى 2 (التحكّم): الشروط if/elif/else، العوامل المنطقية، الحلقات for/while، التكرار والتحكّم break/continue.
- مستوى 3 (الهياكل والدوال): القوائم list، التابل tuple، القواميس dict، المجموعات set، الدوال def والوسائط والقيم المُرجَعة والنطاق scope.
- مستوى 4 (تنظيم وموثوقية): الملفّات (قراءة/كتابة)، الاستثناءات try/except، الوحدات والمكتبات import، الكائنات والأصناف OOP، list comprehension.
- مستوى 5 (تطبيق ومشاريع): خوارزميات (بحث/فرز)، التعقيد البسيط، تنظيم مشروع متعدّد الملفّات، مشروع تطبيقي يمني متكامل، أفضل ممارسات الكود النظيف.
...
- **عمق شرح المفهوم (إلزامي)**: حقل explanation لكل مفهوم فقرة كاملة (3-5 جمل، ≥40 كلمة) تتضمّن: (1) تعريف المفهوم البرمجي بوضوح، (2) لماذا يحتاجه المبرمج عملياً، (3) مقطع/مثال كود بايثون قصير من حياة يمنية، (4) الخطأ الشائع فيه وتصويبه. ممنوع شرح من سطر واحد.
...
- التدرّج المنهجي لبايثون (التزِم به): مستوى1 تأسيس (متغيّرات/أنواع/إدخال-إخراج)، مستوى2 التحكّم (شروط/حلقات)، مستوى3 الهياكل والدوال (list/dict/def)، مستوى4 التنظيم والموثوقية (ملفّات/استثناءات/وحدات/OOP)، مستوى5 الخوارزميات والمشاريع.
- bloom_focus: مستوى1 remember، 2 understand، 3 apply، 4 analyze، 5 evaluate/create.
