...
- المعلّم الذكي يملك أدوات بصرية: `java_trace` (تتبّع الكود سطراً بسطر مع Stack/Heap وقيم المتغيّرات)، `flowchart` (الخوارزميات وقرارات OOP). صمّم المحتوى ليستدعي هذه الأدوات طبيعياً.
