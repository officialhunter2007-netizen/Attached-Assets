...
- المعلّم الذكي يملك أدوات بصرية: `cpp_trace` (تتبّع تنفيذ الكود سطراً سطراً مع المتغيّرات والذاكرة)، `flowchart` (الخوارزميات والقرارات). صمّم المحتوى ليستدعي هذه الأدوات طبيعياً.
