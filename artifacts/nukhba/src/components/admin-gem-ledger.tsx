...
const REASON_LABEL: Record<string, string> = {
  ...
  purchase_gems: "شراء جواهر (v4)",
  platform_revenue: "حصة المنصة (v4)",
  welcome_gift: "هدية ترحيب (v4)",
  monthly_expiry: "انتهاء شهري (v4)",
  renewal_carryover: "ترحيل عند التجديد (v4)",
};
...
const SOURCE_LABEL: Record<string, string> = {
  ...
  v4_purchase: "شراء v4",
  v4_welcome_gift: "هدية ترحيب v4",
  v4_expiry_sweep: "كنس انتهاء v4",
  v4_renewal: "تجديد v4",
  v4_ai_teach: "درس ذكي v4",
  v4_ai_lesson: "توليد درس v4",
  v4_ai_image: "صورة تعليمية v4",
  v4_ai_diagram: "رسم بياني v4",
};
