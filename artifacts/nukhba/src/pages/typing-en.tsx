...
export default function TypingEn() {
      ...
      <div className="min-h-screen" style={{ direction: "ltr" }}>
        <div className="relative overflow-hidden py-10 px-4">
          <div
            ...
            style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(99,102,241,0.10) 0%, transparent 70%)" }}
          />
          <div className="relative max-w-2xl mx-auto">
            <div className="flex items-center gap-3 mb-6" style={{ direction: "rtl" }}>
              <Link href="/typing">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-white/40 mb-1">
                {totalLessons} lessons · 14 sections · Home row to full keyboard mastery
              </p>
              <p className="text-xs text-white/25 mb-6">
                Systematic drills to build speed and accuracy without looking at the keyboard
              </p>
              ...
              <div className="max-w-xs mx-auto mb-3">
                <div className="flex justify-between text-xs mb-1.5" style={{ color: "rgba(255,255,255,0.4)" }}>
                  ...
                  <span className="font-bold" style={{ color: "#818CF8" }}>{overallPct}%</span>
                </div>
