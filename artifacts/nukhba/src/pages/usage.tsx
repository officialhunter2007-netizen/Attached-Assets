...
const REASON_LABEL: Record<string, string> = {
  ...
  purchase_gems: "شراء جواهر",
  platform_revenue: "حصة المنصة",
  welcome_gift: "هدية الترحيب",
  monthly_expiry: "انتهاء الباقة الشهرية",
  renewal_carryover: "ترحيل رصيد عند التجديد",
};
