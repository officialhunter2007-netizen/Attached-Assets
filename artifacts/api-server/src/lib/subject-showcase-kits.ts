...
export const SUBJECT_SHOWCASE_KITS: Record<string, SubjectShowcaseKit> = {
  ...
  "uni-accounting": {
    ...
    labEnvBlueprint: "السياق: أنت محاسب جديد في شركة الأمل التجارية بصنعاء — يناير 2026. صاحب الشركة يطلب منك إثبات 3 معاملات بسيطة وإخراج ميزان مراجعة. البيانات الأولية: رصيد افتتاحي للصندوق 1,000,000 ريال، شراء بضاعة نقداً 500,000، بيع بضاعة نقداً بـ 200,000 (تكلفتها 120,000)، سداد إيجار 80,000. الشاشات: شجرة الحسابات، إدخال القيود، حسابات T، ميزان المراجعة. معايير النجاح: ميزان المراجعة متوازن، صافي الربح 80,000 (مبيعات 200 - تكلفة 120 - إيجار 80 لا… 200-120-80=0)، ورصيد الصندوق النهائي 620,000. الخطأ المتوقّع: عكس طرفَي قيد البيع (وضع البضاعة دائنة بالقيمة البيعية بدل التكلفة، وعدم الفصل بين قيد البيع وقيد تكلفة البضاعة المباعة).",
    imageBlueprint: {
