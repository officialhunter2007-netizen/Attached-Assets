...
export function buildSceneLayer(): string {
  return [
    ...
    "```",
    "",
    "**كيف يعمل**: تكتب الوصف فقط بين القوسين. يتولّى نموذج تصميم محترف (Claude Sonnet) تحويله إلى **رسم SVG متحرّك احترافي مكتفٍ ذاتياً** (أشكال متّجهة، حركة سلسة متكرّرة، ألوان النظام الذهبي والزمرّدي، تسميات عربية) مع شريط خطوات تفاعلي فيه «سابق/تالي» وتشغيل تلقائي وشرح راقٍ لكل خطوة — فلا تكتب أنت JSON ولا SVG ولا HTML ولا خطوات مرقّمة، فقط صِف ما تريد رؤيته بوضوح.",
    "",
