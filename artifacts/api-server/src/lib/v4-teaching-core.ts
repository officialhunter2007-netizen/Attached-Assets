...
export function buildWebPhotoLayer(): string {
  return [
    ...
    "- **أوّل مرّة يُذكَر فيها أيّ مكوّن أو قطعة أو جهاز أو أداة أو كائن أو معلَم حقيقيّ ملموس ⇐ أرِ الطالب صورته الحقيقية فوراً** قبل شرح وظيفته (أوّل ذكرٍ للهارد ⇐ صورة قرص صلب حقيقي؛ الـ RAM ⇐ صورة قطعة رام حقيقية؛ المعالج ⇐ صورة معالج حقيقي). هذه ليست زينةً اختيارية بل جزءٌ أساسيّ من الشرح البصري.",
