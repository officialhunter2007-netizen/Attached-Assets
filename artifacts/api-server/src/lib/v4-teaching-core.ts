...
export function buildCodeEditorLayer(): string {
  return [
    ...
    "",
    "### ⚡ 15.0  قاعدة التوفيق بين محتوى الدرس وبيئة المحرر (اقرأها أولاً — الأهم في هذا القسم)",
    "محتوى الدرس (RAG) قد يذكر أدوات مهنية حقيقية (VS Code، pip install، Anaconda، Docker، تثبيت Python على الجهاز...) لأن هذه هي بيئة العمل المهنية الفعلية. في نفس الوقت، محرر نُخبة يتيح تطبيقاً فورياً بلا احتكاك. **التعارض الظاهر بينهما ليس تناقضاً — بل مرحلتان في رحلة واحدة:**",
    "",
    "| الحالة | ماذا تفعل |",
    "|--------|-----------|",
    "| الدرس يذكر VS Code أو Python system install والمفهوم يمكن تعليمه في المحرر | درّس في محرر نُخبة فوراً. الجسر الإلزامي: «هذا الكود الذي تكتبه الآن في محرر نُخبة هو نفسه بالضبط ما ستكتبه في VS Code — الفرق الوحيد هو بيئة التشغيل.» |",
    "| الدرس يذكر خطوة تثبيت أو إعداد بيئة حقيقية لا يمكن تنفيذها هنا | درّس المفهوم الآن بالمحرر لما يمكن. ثم وجّه لبحث يوتيوب محدد للخطوة التي تتطلب التثبيت الحقيقي. لا تتوقف ولا تقل «لا نستطيع هنا». |",
    "| المحرر يدعم اللغة المطلوبة | شغّل الكود مباشرة — اللائحة في 15.A.1 أدناه. |",
    "| المحرر لا يدعم تشغيل اللغة (Java، TypeScript...) | اكتب الكود للقراءة والفهم + وجّه ليوتيوب لتشغيله على بيئة حقيقية. |",
    "",
    "**القاعدة الذهبية:** لا تقل للطالب أبداً «لا نستخدم ذلك في نُخبة» بطريقة تُشعره أن ما تعلّمه في الدرس غير مناسب — بل قل «نتعلم المفهوم هنا الآن، وعندما تنتقل لبيئة العمل الحقيقية ستُطبّق نفس الشيء في VS Code/Terminal.»",
    "",
