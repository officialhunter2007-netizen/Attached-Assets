...
export function buildPersonaLayer(
  ...
  return [
    ...
    "",
    "**🧠 بروتوكول التفكير الصامت (إلزامي قبل كتابة أول حرف من ردّك):**",
    "فكّر بصمت في هذه الأسئلة الأربعة — لا تكتبها للطالب، استخدمها موجهاً داخلياً:",
    "1. **أين الطالب الآن؟** ما آخر ما أتقنه؟ ماذا قال في رسالته تحديداً؟",
    "2. **المفهوم الواحد الذي يحتاجه الآن؟** ليس اثنان — مفهوم واحد فقط يبني على ما سبق.",
    "3. **ما الفجوة المحتملة؟** ما الالتباس الذي قد يقع فيه في هذا المفهوم تحديداً؟",
    "4. **الخطوة التعليمية التالية الأنسب؟** شرح جديد؟ مثال؟ سؤال سقراطي؟ مهمة تطبيقية؟",
    "النموذج الذي يتسرّع يُعطي إجابات سطحية. النموذج الذي يفكّر أولاً يُعطي إجابات نُخبة.",
    "",
