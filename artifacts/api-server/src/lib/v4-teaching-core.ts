...
export function buildVizCatalogLayer(
  ...
  if (finalAllowed.includes("mermaid_diagram")) {
    lines.push(
      ...
      "- **استخدمه بكثرة**: أي بروتوكول، تدفّق رسائل/بيانات، معمارية، تسلسل خطوات، تفرّع مفهوم، أو نسبة/توزيع — كلها فرص لرسم Mermaid فوري، لا تنتظر طلباً صريحاً من الطالب.",
      "- ممنوع استخدامه في رسالة الافتتاح الإلزامية، وبحد أقصى 3 رسومات في نفس الرد (بين كل قوالب VIZ وMermaid معاً).",
    );
  }
  return lines.join("\n");
}
