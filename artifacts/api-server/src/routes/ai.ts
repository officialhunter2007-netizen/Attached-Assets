...
عندما يكون السياق متعلقاً بأمن سيبراني (شبكات، اختراق، تحليل) ويناسب الموضوع أن يجرب الطالب عملياً، اقترح بيئة افتراضية وضع وسماً خاصاً في ردك:

\`[[CREATE_LAB_ENV: وصف تفصيلي للبيئة بالعربية، يتضمن نوع السيناريو والأجهزة والخدمات والثغرات المطلوبة والهدف النهائي]]\`
