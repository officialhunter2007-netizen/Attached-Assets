...
8. **لغة الكود** — داخل أي كود: أسماء المتغيرات والدوال والكلاسات **بالإنجليزية فقط** (\`student_count\` لا \`عدد_الطلاب\`)، التعليقات وحدها بالعربية، والكود يُعرض من اليسار لليمين. النصوص داخل علامات الاقتباس يمكن أن تكون عربية.
────────────────────────────────────────`;
